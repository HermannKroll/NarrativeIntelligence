...
class QueryTests(unittest.TestCase):
    ...
    def setUp(self):
        self.doc_facts_1 = {'1': [('1', 'p', '2'), ('2', 'p', '3')], '2': [('1', 'q', '10')]}
        self.doc_facts_2 = {'1': [('1', 'p', '2'), ('2', 'p', '3')], '2': [('1', 'p', '10')]}
        self.doc_facts_3 = {'1': [('1', 'p', '2'), ('2', 'p', '3'), ('3', 'p', '1')]}

    def test_match_query_df1(self):
        query = GraphQuery()
        query.add_fact('1', 'p', '2')

        story = StoryProcessor(self.doc_facts_1)
    ...
    def test_1_var_in_query_df2(self):
        ...
        story = StoryProcessor(self.doc_facts_2)
        res = story.match_graph_query(query)
    ...
    def test_3_var_in_query_df3(self):
        ...
        story = StoryProcessor(self.doc_facts_3)
        res = story.match_graph_query(query)
