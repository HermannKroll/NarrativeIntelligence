...
def sample_pubtator_file(pubtator_filename, pubtator_filename_sampled, prob, debug=True,
                ...
                if len(line.rstrip()) == 0:
                    ...
                    if random.random() < prob:
                        ...
                        if len(lines) > min_lines and re.match(r'\d+\|t\|', lines[0]) and re.match(r'\d+\|a\|', lines[1]):
                            ...
                            if skip_documents_due_large_size > 0 and len(lines[1]) > skip_documents_due_large_size:
    ...
    print('Skipped {} documents due to large text size (text size > {})'.format(skipped_docs_due_to_large_size, skip_documents_due_large_size))
