...
from config import TMP_DIR, UMLS_DATA, SEMMEDDB_CONFIG, LOG_DIR

WORKING_DIR = TMP_DIR
UMLS_MESH2CUI_INDEX_TMP_FILE = os.path.join(WORKING_DIR, "umls_mesh2cui_index.pickle")
UMLS_CUI2MESH_INDEX_TMP_FILE = os.path.join(WORKING_DIR, "umls_cui2mesh_index.pickle")
PREDICATES_TMP_FILE = os.path.join(WORKING_DIR, "predicates.pickle")
...
class SemMedDB:
    def __init__(self, config_file=SEMMEDDB_CONFIG, log_enabled=True, log_dir='logs'):
        self.cui2mesh = dict()
        self.mesh2cui = dict()
