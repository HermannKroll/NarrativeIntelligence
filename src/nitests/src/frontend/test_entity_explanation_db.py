...
from narraint.frontend.entity.entityexplainer_db import EntityExplainerDB
...
class EntityExplanationTestCase(TestCase):
    ...
    def setUpClass(cls) -> None:
        ...
        for ent_id, ent_type, ent_class, synonyms in tagger_entries:
            entry = dict(entity_id=ent_id, entity_type=ent_type, entity_class=ent_class, synonym=synonyms)
            entity_tagger_data.append(entry)
        ...
        cls.entity_explainer = EntityExplainerDB()
