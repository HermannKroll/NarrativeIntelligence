...
class TestExtractCount(unittest.TestCase):
    def test_extract(self):
        ...
        self.assertIn(TaggedEntity(document=3, start=97, end=111, text="Ethylene Oxide", ent_type="Chemical", ent_id="MESH:D005027"), tagged_docs[3].tags)
        self.assertIn(TaggedEntity(document=4, start=97, end=111, text="Ethylene Oxide", ent_type="Chemical", ent_id="MESH:D005027"), tagged_docs[4].tags)
