...
def main():
    ...
    parser.add_argument('--cpu', action="store_true", help="Activate to force Stanza to run on CPU")
    ...
    if args.relation_vocab:
        ...
        run_stanza_pathie(args.input, args.output, predicate_vocabulary=relation_vocab.relation_dict, cpu=run_cpu)
    else:
        run_stanza_pathie(args.input, args.output, cpu=run_cpu)
