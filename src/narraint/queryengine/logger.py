...
class QueryLogger:
    ...
    def __init__(self, log_dir=LOG_DIR):
        ...
        self.log_header = 'timestamp\ttime needed\tcollection\tcache hit\thits\tgraph query\n'

    def write_log(self, time_needed, collection, cache_hit: bool, hits_count: int, graph_query: GraphQuery,):
