...
from narraint.frontend.ui.views import get_autocompletion, get_check_query, get_query, post_feedback, \
    ...
    get_explain_document, get_recommend, get_classifications, post_document_classification_feedback, get_content_data, \
    post_entity_ov_search_log, post_entity_ov_subst_href_log, get_pattern_discovery
...
urlpatterns = [
    ...
    path("content_data", get_content_data, name="content_data"),
    path("pattern_discovery", get_pattern_discovery, name="pattern_discovery"),
]
