...
from narraint.frontend.ui.views import get_autocompletion, get_check_query, get_query, post_feedback, \
    ...
    post_drug_suggestion, get_clinical_trial_phases, get_last_db_update, get_recommended_documents
...
urlpatterns = [
    ...
    path("recommended_documents", get_recommended_documents, name="recommended_documents")
]
