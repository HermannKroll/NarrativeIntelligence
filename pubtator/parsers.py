...
class PubTatorParser(Parser):
    ...
    def _split_token(self, sentence_parts, abs_offsets, tok_idx, char_idx, mention, toks, left_tok=True):
        ...
        for k, v in sentence_parts.items():    
    ...
    def parse(self, doc, text):
            ...
            try:
                ...
                for i, anno in enumerate(annotations):
                    ...
                    if si >= start and si < end:
                        ...
                        if ei > end + 1:
                            print("Skipping cross-sentence mention {}".format(mention))
        ...
        if len(annotations) != len(matched_annos):
            ...
            if self.stop_on_err:
                ...
                self.miss_annotations_count = self.miss_annotations_count + 1
                print("WARNING: Annotations missed (Count = {})".format(self.miss_annotations_count))
