...
from tagging.base import get_pmcid_from_filename, get_exception_causing_file_from_log, finalize_dir, merge_result_files
...
class Test(BaseTestCase):
    def setUp(self):
        ...
        self.expected_result_finalize = os.path.join(self.resource_dir, "result_finalize.txt")
