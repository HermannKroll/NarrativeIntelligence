...
eval_q4_ids_correct = {27803295, 22611195}
...
def main():
    ...
    for document_collection, query, id_sample, ids_correct in queries_pubmed:
        ...
        subject_id = query_fact_patterns[1][0]
        subject_type = query_fact_patterns[1][1]
        predicate = query_fact_patterns[1][2]
        object_id = query_fact_patterns[1][3]
        object_type = query_fact_patterns[1][4]
