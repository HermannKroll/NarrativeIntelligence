        ...
        with open(json_file) as file:
            ...
            for d_content in docs_content:
                ...
                for fact in d_content['triples']:
                    ...
                    predicate = _convert_wikidata_uri_to_id(fact['predicate']['uri'])
                    ...
                    key = (document_id, subject_id, predicate, object_id, sentence_id, extraction_type)
                    if key not in existing_facts:
                        ...
                        predication_values.append(dict(
                            ...
                            subject_type="Entity",
                            predicate=predicate,
                            predicate_canonicalized=predicate,
                            object_id=object_id,
