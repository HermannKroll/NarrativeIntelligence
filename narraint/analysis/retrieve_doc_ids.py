...
from narraint.frontend.ui.views import convert_query_text_to_fact_patterns, query_engine
...
query_results = query_engine.query_with_graph_query(query_fact_patterns, q1, collection)
doc_ids = set()
i = 0
